const translations = {
  en: {
    ...
    save: "Save",
    cancel: "Cancel",
    cancelEditing: "Quit the editor without saving?",
    publish: "Publish",
    edit: "Edit",
    delete: "Delete",
    translate: "Translate",
    ...
    includeDocument: "Include document",
    useTools: "Use tools",
  ...
  ru: {
    ...
    save: "Сохранить",
    cancel: "Отмена",
    cancelEditing: "Выйти из редактора не сохраняя?",
    ...
    includeDocument: "Включить документ",
    useTools: "Инструменты",
    saveKey: "Сохранить ключ локально",
    send: "Отправить",
